...
void MainWindow::sendPtrMatrix(PointsAndMatrix*& out_ptrMatrix)
{
    ...
    //Получаю количество вершин и обновляю выпадающие списки
    // (ComboBox 0 и 2, 3-й обновляется в зависимости от 2-го)
...
void MainWindow::on_pushButton_4_clicked()
{
    ...
    {
        QMessageBox::warning(0,"Представление ребра", "неверно указанное значение ребра");
    }
    }
}
